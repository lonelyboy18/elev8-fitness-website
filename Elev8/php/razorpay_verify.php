...
//
// DISABLED — see razorpay_order.php for why. Real implementation preserved below.
//
// TODO(payments): re-enable payment verification + membership activation together — restore the
// code below (HMAC signature check, then marking the payment paid + activating the subscription).
